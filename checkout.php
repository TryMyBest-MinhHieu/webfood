...
<body>
   ...
   <section class="checkout">
      ...
      <h1 class="title">Thánh toán đơn hàng</h1>
      ...
      <form action="" method="post">
         ...
         <div class="user-info">
            ...
            <a href="update_address.php" class="btn">Thay đổi địa chỉ</a>
            <select name="method" class="box" required>
               ...
               <option value="paytm">-- khác --</option>
               
            </select>
            <input type="submit" value="Thanh toán" class="btn <?php if ($fetch_profile['address'] == '') {
                                                                     echo 'disabled';
